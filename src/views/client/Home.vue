<template>
      <!-- Home -->
    <div class="hero bg-white-200 mx-auto py-20">
        <!-- container -->
        <div class="container px-1 sm:px-8 lg:px-16 xl:px-20 mx-auto">
            <!-- Home wrapper -->
            <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center mx-auto">
                <!-- Home text -->
                <div class="hero-text col-span-6 mx-auto py-20">
                    <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight py-8">{{ $t('home.pro') }}<span class="text-blue-700 "> {{ typeValue }}</span></h1>
                    <h1 class=" font-bold text-1xl md:text-1xl max-w-xl text-gray-900 leading-tight">{{ $t('home.by') }}</h1>
                    <hr class=" w-12 h-1 bg-orange-500 rounded-full mt-8">
                    <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight py-8 ">{{ $t('home.cod') }}</h1>
                    <hr class=" w-12 h-1 bg-orange-500 rounded-full mt-8">
                    <p class="text-gray-800 text-base leading-relaxed mt-8 font-semibold">{{ $t('home.come') }}</p>
                    <div class="get-app flex space-x-5 mt-10 justify-center md:justify-start mx-auto py-8">
                        <button class="apple bg-white shadow-md px-4 py-3 rounded-lg flex items-center space-x-5">
                            <div class="logo">
                                <svg 
                                    class="w-6 h-6"
                            ...
                            <div class="text">
                                <p class=" text-xs text-gray-600" style="font-size: 1rem;">Download on the</p>
                        ...
                        <button class="google bg-white shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
                            ...
                            <div class="text">
                                <p class="text-xs text-gray-600" style="font-size: 1rem;">Download it from</p>
                ...
                <div class="hero-image col-span-6">
                  <img src="@/assets/img/undraw_home.svg" alt="hero" class="mx-auto" />
                </div>
            </div>
        </div>
    </div>
...
export default {
  ...
  data() {
    return {
        typeValue: '',
        typeStatus: false,
        typeArray: ['JiHoon', 'Donate', 'Awesome', 'Update'],
        typingSpeed: 200,
        erasingSpeed: 100,
        newTextDelay: 2000,
        typeArrayIndex: 0,
