<template>
  <!-- Footer -->
    <footer class="bg-green-400 py-1 shadow">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-5">
        <div class="mb-8 lg:mb-0 text-center">
          <div> &copy; JiHoon Copyright {{ new Date().getFullYear() }}. All rights reserved.</div>
          <div class="mx-auto">
            <a href="https://facebook.com/meocacahaha" target="_blank" class="text-white hover:text-gray-400 font-normal">JungJi Hoon</a> |
            <a href="" class="text-white hover:text-gray-400 font-normal py-4">Developer</a>
          </div>
        </div>
        <ul class="flex items-center space-x-8">
          <li>
            <a href="gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/meocaca-kits" target="_blank" class="text-white hover:text-gray-400">
