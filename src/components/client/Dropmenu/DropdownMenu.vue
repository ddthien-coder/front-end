<template>
  <div class="relative">
    ...
    >
      <img src="@/assets/img/avatar.jpg" alt="avatar" class="w-8 h-8 rounded-full">
      ...
      <ul v-on-clickaway="hideDropdown" v-if="isVisible" ref="dropdown" class="absolute normal-case font-normal xs:left-0 lg:right-0 bg-white shadow overflow-hidden rounded w-48 border mt-2 py-1 lg:z-20">
        <li>
          ...
          >
            ...
            <span class="ml-2">{{ $t('user.account') }}</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="ml-2">{{ $t('user.bi') }}</span>
          </a>
        </li>
         <li>
          <a
          ...
          >
            ...
            <span class="ml-2">{{ $t('user.cart') }}</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="ml-2">{{ $t('user.help') }}</span>
          </a>
        </li>
        <li class="border-b border-gray-400">
          ...
          >
            ...
            <span class="ml-2">{{ $t('user.set') }}</span>
          </a>
        </li>
        <li>
          <a
